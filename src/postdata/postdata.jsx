...
const Postdata = () => {
    ...
    let url="https://booklist-backend-7a7u.onrender.com/afterlogin/postbookdata"
  ...
  return (
    <div id="postmain">
      ...
      <br />
      <br />
      <button type="submit" style={{width:"500px",height:"40px",borderRadius:"20px",backgroundColor:"blue",color:"white"}}>Submit</button>
    </form>
    </div>
